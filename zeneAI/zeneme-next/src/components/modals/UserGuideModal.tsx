...
export const UserGuideModal: React.FC<UserGuideModalProps> = ({ open, onOpenChange }) => {
        ...
        <div className="max-h-[60vh] overflow-y-auto custom-scrollbar bg-[#161825] p-6 space-y-8 animate-in fade-in-50 duration-300">
          {guide.sections.map((section, index) => (
            <div key={index} className="space-y-3">
              ...
              {section.list ? (
                <ul className="list-disc list-inside text-sm leading-relaxed text-slate-400 space-y-1 pl-1">
